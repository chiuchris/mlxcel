...
//!
//! Qwen3-VL vision encoder + DeepStack + MoE text backbone
...
/// Qwen3-VL-MoE VLM: Qwen3-VL vision encoder + DeepStack + MoE text backbone
///
/// Same vision pipeline as Qwen3-VL, but the text model uses mixture-of-experts layers.
pub struct Qwen3VLMoeModel {
    pub text_model: crate::models::Qwen3VLMoeModel,
...
impl LanguageModel for Qwen3VLMoeModel {
    fn forward(
        &self,
        input_ids: &MlxArray,
        caches: &mut [KVCache],
