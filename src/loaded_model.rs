...
pub enum LoadedModel {
    ...
    FastVLM(vision::VisionLanguageModel),
    GraniteVisionVLM(vision::GraniteVisionVLModel),
    Granite4VisionVLM(vision::Granite4VisionVLModel),
    DeepSeekOcrVLM(vision::deepseekocr::DeepSeekOcrVlModel),
    DeepSeekOcr2VLM(vision::deepseekocr_2::DeepSeekOcr2VlModel),
    DeepSeekVL2(vision::deepseek_vl2::DeepSeekVl2VlModel),
    ...
    DotsOcrVL(vision::DotsOcrVlModel),
...
macro_rules! delegate_language_model {
    ($self:expr, $method:ident ( $($arg:expr),* $(,)? )) => {
        match $self {
            ...
            LoadedModel::FastVLM(inner) => LanguageModel::$method(inner, $($arg),*),
            ...
            LoadedModel::DeepSeekOcrVLM(inner) => LanguageModel::$method(inner, $($arg),*),
            LoadedModel::DeepSeekOcr2VLM(inner) => LanguageModel::$method(inner, $($arg),*),
            LoadedModel::DeepSeekVL2(inner) => LanguageModel::$method(inner, $($arg),*),
            ...
            LoadedModel::DotsOcrVL(inner) => LanguageModel::$method(inner, $($arg),*),
