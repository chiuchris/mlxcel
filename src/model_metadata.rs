...
macro_rules! for_each_model_registration {
    ($macro:ident) => {
        $macro! {
            ...
            Llada2Moe => { kind: Text, directory: Nonstandard, weight: None, adapter: Some("LLaDA-2 MoE cannot be loaded with LoRA adapters yet") };
            ...
            DeepSeekOcr2VLM => { kind: Vlm, directory: Vlm, weight: None, adapter: Some("DeepSeek-OCR 2 VLM cannot be loaded with LoRA adapters yet") };
