...
pub struct LlamaStageExecutor {
    model: TransformerStageModel<LlamaStageLayer>,
}
...
impl FamilyStageExecutor for LlamaStageExecutor {
...
struct LlamaStageLayer(models::llama3::TransformerBlock);

impl TransformerStageLayer for LlamaStageLayer {
    fn forward(
        &self,
        hidden: &MlxArray,
        cache: &mut KVCache,
