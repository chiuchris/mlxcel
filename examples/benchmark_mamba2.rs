//! Benchmark for Mamba2 model using mlxcel-core
//!
//! This binary loads the Mamba2 pure SSM model and benchmarks
//! token generation throughput.

use mlxcel::models::mamba2::Mamba2Model;
use mlxcel_core::generate::{CxxGenerator, SamplingConfig};
use std::time::Instant;

const MODEL_PATH: &str = "models/mamba2-1.3b-4bit";

fn main() {
    println!("=======================================================");
    println!("  Mamba2 1.3B Benchmark - mlxcel-core");
    println!("=======================================================");
    println!();
    ...
    let (model, args) = match Mamba2Model::load(MODEL_PATH) {
        Ok(result) => result,
        Err(e) => {
    ...
    println!("  Num heads: {}", args.num_heads);
    println!("  Head dim: {}", args.head_dim);
    println!("  State size: {}", args.state_size);
    println!();
    ...
    // Test prompt tokens (use bos_token=0 for Mamba2)
    let prompt_tokens = vec![0_i32, 9906, 11, 1268, 527, 499, 3432, 30, 358, 1097];
